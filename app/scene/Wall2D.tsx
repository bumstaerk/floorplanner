...
export function Wall2D({ wallId }: Wall2DProps) {
  ...
  const fillColor = isInvisible
    ? isSelected
      ? colors.wallFillInvisibleSelected
      : isHovered
        ? colors.wallFillInvisibleHovered
        : colors.wallFillInvisible
    : isSelected
      ? colors.wallFillSelected
      : isHovered
        ? colors.wallFillHovered
        : colors.wallFillDefault;
  const outlineColor = isInvisible
    ? isSelected
      ? colors.wallOutlineInvisibleSelected
      : isHovered
        ? colors.wallOutlineInvisibleHovered
        : colors.wallOutlineInvisible
    : isSelected
      ? colors.wallOutlineSelected
      : isHovered
        ? colors.wallOutlineHovered
        : colors.wallOutlineDefault;
  const labelColor = isSelected
    ? colors.wallLabelSelected
    : colors.wallLabelDefault;
    ...
    <group>
      ...
      {isInvisible && (
        <Text
          ...
          fontSize={0.07}
          color={colors.wallInvisibleBadge}
          anchorX="center"
          anchorY="middle"
          outlineWidth={0.006}
      ...
      {isSelected && (
        <Text
          ...
          color={
            isInvisible
              ? colors.wallDimensionLabelInvisible
              : colors.wallDimensionLabel
          }
          anchorX="center"
          anchorY="middle"
          outlineWidth={0.008}
