        ...
        return openings
            ...
            .map((opening) => {
                ...
                const clampedTop = Math.min(
                    height,
                    opening.elevation + opening.height,
                );
                    ...
                    <line>
                        <bufferGeometry>
                            <bufferAttribute
                                ...
                                args={[
                                    new Float32Array(frame.frontFrame.flat()),
                                    3,
                                ]}
                            />
                        </bufferGeometry>
                        <lineBasicMaterial color="#5a7a9a" linewidth={1} />
                    </line>
                    <line>
                        <bufferGeometry>
                            <bufferAttribute
                                attach="attributes-position"
                                args={[
                                    new Float32Array(frame.backFrame.flat()),
                                    3,
                                ]}
                            />
                        </bufferGeometry>
                    ...
                    <line>
                        <bufferGeometry>
                            <bufferAttribute
                                attach="attributes-position"
                                args={[
                                    new Float32Array(frame.frontCrossV.flat()),
                                    3,
                                ]}
                            />
                        </bufferGeometry>
                    ...
                    <line>
                        <bufferGeometry>
                            <bufferAttribute
                                attach="attributes-position"
                                args={[
                                    new Float32Array(frame.frontCrossH.flat()),
                                    3,
                                ]}
                            />
                        </bufferGeometry>
                    ...
                    <line>
                        <bufferGeometry>
                            <bufferAttribute
                                attach="attributes-position"
                                args={[
                                    new Float32Array(frame.backCrossV.flat()),
                                    3,
                                ]}
                            />
                        </bufferGeometry>
                    ...
                    <line>
                        <bufferGeometry>
                            <bufferAttribute
                                attach="attributes-position"
                                args={[
                                    new Float32Array(frame.backCrossH.flat()),
                                    3,
                                ]}
                            />
                        </bufferGeometry>
            ...
            {doorFrames.map((frame) => (
                <group key={frame.id}>
                    <line>
                        ...
                        <lineBasicMaterial color="#8b6f47" linewidth={1} />
                    </line>
                    <line>
                        <bufferGeometry>
                            <bufferAttribute
